  ...
  <section class="bg-content bg-backgroundHeader bg-cover bg-center px-6 py-6 flex flex-col relative">
    ...
    <header class="my-menu flex justify-center">
      ...
      <div class="h-full mx-12">
        <nav class="h-full flex justify-between items-center px-6 mx-6">
          <button class="text-white rounded-full px-8 font-montserrat text-lg transition-all ease-in duration-150 hover:py-9 hover:px-8 hover:text-mygreen hover:bg-white hover:transition-all hover:ease-in hover:duration-150 hover:focus:outline-none hover:rounded-full"><i class="bx bx-cart text-2xl"></i></button>
          <button class="text-white rounded-full px-8 font-montserrat text-lg transition-all ease-in duration-150 hover:py-9 hover:px-8 hover:text-mygreen hover:bg-white hover:transition-all hover:ease-in hover:duration-150 hover:focus:outline-none hover:rounded-full"><i class="bx bx-user-circle text-2xl"></i></button>
        </nav>
      </div>
